...
const LandingSection = () => {
  return (
    <Section>
      <div className="text-background flex items-center justify-center gap-x-4 rounded-full bg-white px-8 py-3 shadow-[0_18px_48px_rgba(0,0,0,0.32),0_0_20px_rgba(113,221,174,0.4),0_0_20px_rgba(113,221,174,0.2)]">
